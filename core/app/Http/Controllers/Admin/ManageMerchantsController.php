...
class ManageMerchantsController extends Controller
{
    ...
    {
        $pageTitle = 'Manage Active Sellers';
    ...
    {
        $pageTitle = 'Email Unverified Sellers';
    ...
    {
        $pageTitle = 'Email Verified Sellers';
    ...
    {
        $pageTitle = 'SMS Unverified Sellers';
    ...
    {
        $pageTitle = 'SMS Verified Sellers';
    ...
    {
        $merchant = Merchant::findOrFail($request->seller_id);
        $merchant->delete();
        $notify[] = ['success', 'Seller has been deleted'];
    ...
    {
        $merchant = Merchant::findOrFail($id);
        $pageTitle = 'Seller Login History - ' . $merchant->username;
        $emptyMessage = 'No Sellers login found.';
    ...
    public function transactions(Request $request, $id)
    {
        ...
        if ($request->search) {
            $search = $request->search;
            $pageTitle = 'Search Seller Transactions : ' . $merchant->username;
        ...
        $pageTitle = 'Seller Transactions : ' . $merchant->username;
    ...
    public function products(Request $request, $id){
        $merchant = Merchant::findOrFail($id);
        $pageTitle = 'Seller Product : ' . $merchant->username;
    ...
    public function withdrawals(Request $request, $id)
    {
        ...
        if ($request->search) {
            $search = $request->search;
            $pageTitle = 'Search Seller Withdrawals : ' . $merchant->username;
        ...
        $pageTitle = 'Seller Withdrawals : ' . $merchant->username;
    ...
    {
        $pageTitle = 'Send Email To All Sellers';
    ...
    public function sendEmailAll(Request $request)
    {
        ...
        $notify[] = ['success', 'All Sellers will receive an email shortly.'];
        return back()->withNotify($notify);
    }
