                                ...
                                <div class="form-group">
                                    ...
                                    <div class="thumb" style="width: 350px;">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <input type="hidden" value='{{ route("merchant.product.oneimage") }}' id="url_hidden" >
                                            <input type="hidden" value='0' id="imagenum_hidden" >
                                            <input type="file" style="padding: 0;" name="image" class="profilePicUpload" id="image" accept=".png, .jpg, .jpegm, .bmp"  multiple required/>
                                            <label for="image" class="bg--primary" style="position: relative;">
                                                <i class="fas fa-image" style="font-size: 28px; vertical-align: middle;"></i>
                                                <div style="position: absolute; bottom: 4px; right: 4px; background: #7332f1 !important; display: flex; border-radius: 50%;">
                                        ...
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15">
                                            <div class="form-group">
                                                ...
                                                <select name="schedule" class="form-control" required>
                                                    ...
                                                    <option value="1weeks">@lang('1 week') (0,50 Euro)</option>
                                                    <option value="2weeks">@lang('2 weeks') (0,70 Euro)</option>
                                                    <option value="3weeks">@lang('3 weeks') (0,90 Euro)</option>
                                                    <option value="4weeks">@lang('4 weeks') (1,00 Euro)</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15 started_at">
                                            <div class="form-group">
                                                <label class="w-100 font-weight-bold">@lang('Start') <span class="text-danger">@lang('now')</span></label>
                                                <input type="text" name="started_at" placeholder="@lang('or select Date & Time')" id="startDateTime" data-position="bottom left" class="form-control border-radius-5" value="{{ old('date_time') }}" autocomplete="off"/>
                                            </div>
                                        </div>
                                        <!--<div class="col-sm-12 col-xl-4 col-lg-6 mb-15">-->
                                        <!--    <div class="form-group">-->
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--primary mt-3">
                                            <h5 class="card-header bg--primary  text-white">@lang('Specification')
                                                <!--<button type="button" class="btn btn-sm btn-outline-light float-right addUserData"><i class="la la-fw la-plus"></i>@lang('Add New')</button>-->
                                            </h5>
                                            ...
                                            <div class="card-body">
                                                <div class="row addedField">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-md-0 mb-4">
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <input name="specification[1][value]" class="form-control classCreator" type="text" placeholder="@lang('Field Value')" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 user-data">
                                                        <div class="form-group">
                                                            <div class="input-group mb-md-0 mb-4">
                                                                <div class="col-md-4 ownspecification" style="display: flex; margin: auto; justify-content: flex-end; align-items: center;">
                                                                    <input type="text"  value="" name="specification[10][name]" placeholder="@lang('Own Specification')" class="form-control classAnythingfirst" />
                                                                    <span>:</span>
                                                                </div>
                                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-12 user-data">
                                                        <div class="form-group">
                                                            <div class="input-group mb-md-0 mb-4">
                                                                <div class="col-md-4 ownspecification" style="display: flex; margin: auto; justify-content: flex-end; align-items: center;">
                                                                    <input type="text"  value="" name="specification[11][name]" placeholder="@lang('Own Specification')" class="form-control classAnythingfirst" />
                                                                    <span>:</span>
                                                                </div>
                                                                <div class="col-md-8">
...
@push('breadcrumb-plugins')
    <a href="{{ route('merchant.product.index') }}" class="btn btn-sm btn--primary text--small"><i class="la la-fw la-backward"></i> @lang('Go Back') </a>
@endpush
