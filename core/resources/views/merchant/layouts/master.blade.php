...
<head>
    ...
    <script>
        if(localStorage.getItem("lightmodedata") != null && localStorage.getItem("lightmodedata") != "null") {
            $('head').append(`<link rel="stylesheet" href="{{ asset('assets/admin/css/merchantdarkmode.css') }}">`);
        } else {
            $('head').append(`<link rel="stylesheet" href="{{ asset('assets/admin/css/merchantlightmode.css') }}">`);
        }
    </script>
</head>
<body>
