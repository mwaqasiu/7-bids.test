    ...
    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--green b-radius--10 box-shadow">
            <div class="details">
                ...
                <div class="desciption">
                    <span class="text--small">@lang('Total Highest Price Offers')</span>
                </div>
                <a href="{{ route('merchant.bids') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View Price Offers')</a>
            </div>
        </div>
    </div>
</div>
...
<div class="card b-radius--10 mt-4">
    <div class="card-header">
        ...
        <a href="{{ route('merchant.transactions') }}" class="btn btn-sm btn--primary text--small float-right">@lang('View All')</a>
    </div>
