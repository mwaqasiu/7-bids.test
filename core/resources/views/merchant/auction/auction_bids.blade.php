            ...
            <table class="table table--light style--two">
                ...
                <tr>
                    ...
                    <td data-label="@lang('User Name')">{{ __($bid->user->fullname) }} <br>
                        @php $bidId = $bid->auctionwinner ? $bid->auctionwinner->bid_id : ''; @endphp
                        @if ($bid->id == $bidId)
...
<div id="bidModal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('merchant.auction.bid.winner') }}" method="POST">
                @csrf
...
<a href="{{ route('merchant.product.auction.index') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-fw la-backward"></i> @lang('Go Back') </a>
@endpush
