...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('merchant.product.auction.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="thumb" style="width: 350px;">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <input type="hidden" value='{{ route("merchant.product.auction.oneimage") }}' id="url_hidden" >
                                        ...
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15">
                                            <div class="form-group">
                                                ...
                                                <select name="schedule" class="form-control" required>
                                                    ...
                                                    <option value="1weeks">@lang('1 week')</option>
