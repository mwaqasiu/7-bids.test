...
@section('panel')
        ...
        <div class="col-xl-3 col-lg-5 col-md-5 mb-30">
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Bonus Points')
                            <span class="font-weight-bold">{{ showAmount($user->bonuspoint, 0) }} pts</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <a data-toggle="modal" href="#addSubBonusModal" class="btn btn--success btn--shadow btn-block btn-lg">
                        @lang('Add/Substract Bonus Points')
                    </a>
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.users.update',[$user->id])}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group  col-xl-4  col-sm-3 col-12">
                            ...
                            <div class="form-group  col-xl-4  col-sm-3 col-12">
                                <label class="form-control-label font-weight-bold">@lang('Seller Status') </label>
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       data-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="sellerstatus"
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group has_append">
                                    <input type="text" name="detail" class="form-control" placeholder="@lang('Please type detail')">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    {{-- Add Sub Bonus Point MODAL --}}
    <div id="addSubBonusModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Add / Subtract Bonus Points')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{route('admin.users.add.sub.bonus', $user->id)}}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Add')" data-off="@lang('Subtract')" name="act" checked>
                            </div>
                            <div class="form-group col-md-12">
                                <label>@lang('Bonus Points')<span class="text-danger">*</span></label>
                                <div class="input-group has_append">
                                    <input type="text" name="amount" class="form-control" placeholder="@lang('Please provide positive amount')">
                                    <div class="input-group-append">
                                        <div class="input-group-text">@lang('P')</div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-12">
