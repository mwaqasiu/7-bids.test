                ...
                <form action="" method="post">
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="form-group">
                          <label>@lang('German Description')</label>
                            <textarea class="form-control nicEdit" rows="10" name="german_description" placeholder="@lang('Description')">@php echo @$cookie->data_values->german_description @endphp</textarea>
                        </div>
                    </div>
