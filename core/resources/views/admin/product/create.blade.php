                            ...
                            <div class="payment-method-header">
                                ...
                                <div class="content content_div_blk" style="width: calc(100% - 350px);">
                                    <div class="row mb-none-15">
                                        ...
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15">
                                            <div class="form-group">
                                                <label class="w-100 font-weight-bold">@lang('Schedule')</label>
                                        ...
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15">
                                            <label class="w-100 font-weight-bold">@lang('New Price')</label>
                                            <div class="input-group has_append">
                                                <input type="text" class="form-control" placeholder="0" name="newprice" value="{{ old('newprice') }}"/>
                                                <div class="input-group-append">
                                                    <span class="input-group-text">{{ __($general->cur_text) }}</span>
                                                </div>
                                            </div>
