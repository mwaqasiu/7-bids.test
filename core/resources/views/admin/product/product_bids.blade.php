            ...
            <table class="table table--light style--two">
                ...
                <tr>
                    ...
                    <td data-label="@lang('Action')">
                        <button type="button" class="icon-btn btn--success bid-details" data-toggle="tooltip" data-original-title="@lang('Make Winner')"
                            data-bid_id="{{ $bid->id }}"
                        ...
                        <a href="{{ route('admin.bid.decline', $bid->id) }}" class="icon-btn btn--danger" data-toggle="tooltip" data-original-title="@lang('Decline Winner')">
