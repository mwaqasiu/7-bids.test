    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.sliders')}}">
                    <a href="{{route('admin.sliders')}}" class="nav-link ">
                        <i class="menu-icon la la-list"></i>
                        <span class="menu-title">@lang('Slider')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{menuActive('admin.frontsliders')}}">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.charity')}}">
                    <a href="{{route('admin.charity')}}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Charity Project')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.product*',3)}}">
                        ...
                        @if($pending_product_count > 0)
                            <span class="menu-badge pill comma-hint-icons ml-auto">
                        ...
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.product.index')}} ">
                                <a href="{{route('admin.product.index')}}" class="nav-link">
                                    ...
                                    <span class="menu-title">@lang('Marketplace')</span>
                                    @if($live_product_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$live_product_count}}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.product.auction.index')}} ">
                                <a href="{{route('admin.product.auction.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Auction')</span>
                                    @if($live_auction_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$live_auction_count}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.product.winners')}} ">
                                <a href="{{route('admin.product.winners')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Marketplace Sales')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.product.auction.winners')}} ">
                                <a href="{{route('admin.product.auction.winners')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Auction Sales')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.users*',3)}}">
                        ...
                        <span class="menu-title">@lang('List of Buyers')</span>
                        ...
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.users.all')}} ">
                                <a href="{{route('admin.users.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Buyers')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.users.active')}} ">
                                <a href="{{route('admin.users.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Buyers')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.users.banned')}} ">
                                <a href="{{route('admin.users.banned')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Banned Buyers')</span>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.merchants*',3)}}">
                        ...
                        <span class="menu-title">@lang('List of Sellers')</span>
                        ...
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.merchants.all')}} ">
                                <a href="{{route('admin.merchants.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Sellers')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.paymentmethod')}}">
