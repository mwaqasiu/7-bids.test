                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    <button class="icon-btn btn--danger deleteCategory" data-id="{{ $category->id }}"><i class="la la-trash"></i></button>
                                </td>
                            </tr>
                            @empty
                                <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin.category.delete')}}" method="POST">
                ...
                <div class="modal-body">
                    <p>@lang('Are you sure to') <span class="font-weight-bold">@lang('delete')</span> @lang('this category') <span class="font-weight-bold withdraw-user"></span>?</p>
                </div>
