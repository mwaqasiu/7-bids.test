        ...
        <div class="col-sm-6 col-xl-4">
            <div class="auction__item bg--body">
                <div class="auction__item-thumb">
                    ...
                    @if (auth()->check())
                        <a class="item_heart_icon" href="{{ route('user.wishlist.add', [$product->id, auth()->user()->id, getenv('REMOTE_ADDR')]) }}" title="@lang('Add to wishlist')">
                            <span><i class="far la-heart"></i></span>
                        </a>
                    @else
                        <a class="item_heart_icon" href="{{ route('user.wishlist.add', [$product->id, 'empty', getenv('REMOTE_ADDR')]) }}" title="@lang('Add to wishlist')">
                            <span><i class="far la-heart"></i></span>
                        </a>
                    @endif
                </div>
        ...
        <div class="col-sm-6 col-xl-4">
            <div class="auction__item bg--body">
                <div class="auction__item-thumb">
                    ...
                    @if (auth()->check())
                        <a class="item_heart_icon" href="{{ route('user.auctionwishlist.add', [$auction->id, auth()->user()->id, getenv('REMOTE_ADDR')]) }}" title="@lang('Add to wishlist')">
                            <span><i class="far la-heart"></i></span>
                        </a>
                    @else
                        <a class="item_heart_icon" href="{{ route('user.auctionwishlist.add', [$auction->id, 'empty', getenv('REMOTE_ADDR')]) }}" title="@lang('Add to wishlist')">
                            <span><i class="far la-heart"></i></span>
                        </a>
                    @endif
                </div>
