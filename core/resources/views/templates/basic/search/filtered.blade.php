...
<div class="d-flex justify-content-end my-4">
    <div>@lang('Results Found'): <span>{{ $products->total() + $auctions->total() }}</span></div>
</div>
<div class="row g-4">
        ...
        <div class="col-sm-6 col-xl-4">
            <div class="auction__item bg--body">
                <div class="auction__item-thumb">
                    ...
                    @endif
                    <div style="border: 1px solid transparent; display: flex; position: relative; width: calc(100%); padding-top: calc(100%); overflow: hidden;">
                        <img style="padding: 0.25rem; width: 100%; height: 100%; position: absolute; top: 0; right: 0; left: 0; bottom: 0; object-fit: fill;" src="{{getImage(imagePath()['product']['path'].'/thumb_'.$product->image,imagePath()['product']['thumb'])}}" alt="auction">
                    </div>
                </div>
                <div class="auction__item-content">
                    <div class="item_provenance_icon">
                        ...
                        @if (auth()->check())
                            ...
                            @endforeach
                            @if($wishnum > 0)
                                <a style="cursor: pointer" class="item_heart_icon_red" href="{{ route('user.wishlist.onedelete', [$wishid]) }}" title="@lang('Delete to wish list')">
    ...
    @forelse ($auctions as $auction)
        <div class="col-sm-6 col-xl-4">
            <div class="auction__item bg--body">
                <div class="auction__item-thumb">
                    @if(isset($auction->auctionwinner))
                        <div class="soldactive">
                            <div>
                                @lang('SOLD')
                            </div>
                    ...
                    @endif
                    <div style="border: 1px solid transparent; display: flex; position: relative; width: calc(100%); padding-top: calc(100%); overflow: hidden;">
                        <img style="padding: 0.25rem; width: 100%; height: 100%; position: absolute; top: 0; right: 0; left: 0; bottom: 0; object-fit: fill;" src="{{getImage(imagePath()['product']['path'].'/thumb_'.$auction->image,imagePath()['product']['thumb'])}}" alt="auction">
                    </div>
                </div>
                <div class="auction__item-content">
                    <div class="item_provenance_icon">
                        ...
                        @if (auth()->check())
                            ...
                            @endforeach
                            @if($auctionwishnum > 0)
                                <a style="cursor: pointer" class="item_heart_icon_red" href="{{ route('user.auctionwishlist.onedelete', [$auctionwishid]) }}" title="@lang('Delete to wish list')">
                                    <span><i class="lar la-heart"></i></span>
                                </a>
                            @else
