...
<div class="header-bottom">
    <div class="container">
        ...
        <div class="heaer-wrapper second-header-part-section">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div></div>
        ...
        <div class="header-wrapper">
            <div class="menu-area">
                ...
                <div class="change-language d-md-none mt-4 justify-content-center">
                    <div class="sign-in-up">
                        <span><i class="fas la-user"></i></span>
                        <a href="{{ route('user.home') }}" style="font-size: 14px; font-family: 'Jost', sans-serif">@lang('Buyer Dashboard')</a>
                    </div>
                </div>
                @endauth
                @auth('merchant')
                <div class="change-language d-md-none mt-4 justify-content-center">
                    <div class="sign-in-up">
                        <span><i class="fas la-user"></i></span>
                        <a href="{{ route('merchant.dashboard') }}" style="font-size: 14px; font-family: 'Jost', sans-serif">@lang('Seller Dashboard')</a>
                    </div>
                </div>
                @endauth
            ...
            <div class="change-language ms-auto me-3 me-lg-0">
                <div class="sign-in-up d-none d-sm-block">
                    ...
                    @if (auth()->check())
                        <span>
                            <a style="position: relative;" href="{{ route('user.wishlist', [auth()->user()->id, getenv('REMOTE_ADDR')]) }}">
                                @if($wishlist_count > 0)
                                    <i class="fas la-heart" style="color: red !important;"></i>
                                @else
                                    <i class="fas la-heart"></i>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('german.change.lang') }}" method="POST">
                    @csrf
                    <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; margin: 15px 0;">
                       <div style="margin-bottom: 30px;">
                            <img src="https://www.geonames.org/flags/x/de.gif" class="languageimageclass" width="100px" />
                       </div>
                        <p class="languagepclass" style="margin: 0; padding: 0; font-size: 24px; font-weight: bold; margin-bottom: 30px; text-align: center;">Ihre Sprache ist auf Deutsch festgelegt.</p>
                       ...
                       <div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                           ...
                           <p style="margin: 0; padding: 0; font-size: 24px; margin-bottom: 20px; text-align: center;">Other language?</p>
                           <select class="lagnuagesettingselect language" name="germanlang" style="height: 32px; padding-left: 5px; border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 4px; outline: none; background: transparent; color: #fff;">
