...
<head>
    ...
    <script>
        if(localStorage.getItem("lightmodedata") != null && localStorage.getItem("lightmodedata") != "null") {
            $('head').append(`<link rel="stylesheet" href="{{ asset('assets/admin/css/userdarkmode.css') }}">`);
        } else {
            $('head').append(`<link rel="stylesheet" href="{{ asset('assets/admin/css/userlightmode.css') }}">`);
        }
    </script>
</head>
<body>
