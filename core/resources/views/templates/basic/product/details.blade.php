                                ...
                                <div class="product-thumb pe-md-4" style="position: relative;">
                                    <div style="display: flex; position: relative;">
                                            ...
                                            @if ($product->specification)
                                                @foreach ($product->specification as $spec)
                                                    ...
                                                    @elseif ($spec['name'] == "Literature")
                                                        @if ($spec['value'] == "" && $spec['value'] == null)
                                                        @else
                                                            <i class="fas fa-book-open icon_select attachiconpaper" data-imgsrc="{{$spec['value']}}" title="Mentioned in Literature"></i>
                                                        @endif
                                                    ...
                                                    @elseif ($spec['name'] == "Provenance")
                                                        @if ($spec['value'] == "" && $spec['value'] == null)
                                                        @else
                                                            <i class="fas fa-crown icon_select attachiconpaper" data-imgsrc="{{$spec['value']}}" title="Noteworthy Provenance"></i>
                                                        @endif
                                                    @endif
                                                @endforeach
                                            @endif
                                        ...
                                        <div class="product_detail_image_section">
                                            ...
                                            @endif
                                            <div class="newpricecalc">
                                                @if(number_format($product->newprice) != 0)
                                ...
                                <div class="tab-content">
                                                                ...
                                                                @else
                                                                    <tr>
                                                                        ...
                                                                        @elseif($spec['name'] == "Certificated")
                                                                            <th>Certificated</th>
                                                                        @elseif($spec['name'] == "Literature")
                                                                            <th>Mentioned in Literature</th>
                                                                        @elseif($spec['name'] == "Edition")
                                                                            <th>Limited Edition</th>
                                                                        @elseif($spec['name'] == "Provenance")
                                                                            <th>Noteworthy Provenance</th>
                                                                        @endif
                                                                        <td>
                                                                            <label style="padding: 0; margin: 0;" class="attachiconpaper" data-imgsrc="{{$spec['value']}}">
                                                                                <span style="margin-right: 5px;">{{$spec['value']}}</span>
                                    ...
                                    <div class="tab-pane" id="ask_question">
                                        <div class="contact-section contact-wrapper bg--section pt-3" style="border: unset !important; box-shadow: unset !important;">
                                            <form action="{{ route('user.product.question.save') }}" method="POST" class="contact-form row">
                                                @csrf
                                                <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label for="question" class="form--label">@lang('Message')</label>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group mb-0">
                                                        @if(auth()->user())
                                                            <button type="submit" class="cmn--btn w-100" style="border-color: #000 !important;">@lang('SUBMIT')</button>
                                                        @else
                                        ...
                                        <div class="contact-section mt-4">
                                            @php
                                                $admin = $product->admin_id != 0 ? true : false;
                                            @endphp
                                            @if($productquestions_count > 0)
                                                @foreach($productquestions as $productquestion)
                                                    <div class="question-item">
                                                        <p style="margin: 0px; font-weight: bold;">@lang('Question') {{ showDateTime($productquestion->created_at) }}</p>
                                                        <div style="color: red !important;">{{ $productquestion->username }}: {{ $productquestion->question }}</div>
                                                        @if($productanswers->count() > 0)
                                                            <div style="margin-top: 0px;">
                                                                @foreach($productanswers as $productanswer)
                                                                    @if($productanswer->question_id == $productquestion->id)
                                                                        <div class="answer-item">
                                                                            <div style="color: green !important;">{{ __($admin ? $product->admin->username : $product->merchant->username) }}: {{ $productanswer->answer }}</div>
                                                                        </div>
                                                                    @endif
                                                                @endforeach
                                                            </div>
                ...
                <div class="modal-content modal_image_content_big" style="flex-direction: row; background-color: rgba(0, 0, 0, 0.8); /* box-shadow: 0px 0px 2px 2px rgba(255, 255, 255, 0.3); */">
                    ...
                    <div class="modal_img_list" style="position: relative;">
                        <div class="selected_img_download">
                            <a class="a_download_img" target="_blank" download rel="nofollow" title="@lang('Download Photo')" href="#">
...
<script>
    ...
    (function ($) {
        ...
        $('.empty-message').hide();
        $('.bid_now_modal_btn').on('click',function() {
            var modal = $('#bidModal');
        ...
        $('.currencylistbtn').on('click', function() {
            if(currencyflag) {
                $('.currencylist').css('display', "flex");
                currencyflag = false;
            } else {
