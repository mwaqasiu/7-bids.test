    ...
    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--primary b-radius--10 box-shadow">
            <div class="details">
                ...
                @if($widget['balance'] <= 0)
                    <button class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3 deleteOneAuction" style="background-color: rgba(0, 0, 0, 0.3) !important; color: #fff !important;">@lang('Close Account')</button>
                @endif
            </div>
        </div>
    </div>
...
<div id="deleteModal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('user.closeaccount.close')}}" method="GET">
                @csrf
                ...
                <div style="padding: 0 1rem 1rem 1rem;">
                    <p>
                        ...
                        @lang('This means that any content remaining to this account and all associated records will be deleted from the online platform within 7 days.')
