(function ($) {
    ...
    $('.close-filter-bar').on('click', function () {
        ...
        $('.search-filter').hasClass('active') ? $('.header-bottom').css({
            "opacity": "0",
            "visibility": "hidden"
        }) : $('.header-bottom').css({"opacity": "1", "visibility": "visible"});
    })
    ...
    // })
    $('.filter-btn-sticky').on('click', function () {
        $('.search-filter').addClass('active');
        $('.search-filter').hasClass('active') ? $('.header-bottom').css({
            "opacity": "0",
            "visibility": "hidden"
    ...
    // Sort Buttons
    // $('.sort-btn-sticky').on('click', function () {
    //     // if ($('.sort-fields').hasClass('active')) {
    //     //     $('.sort-fields').addClass('invisible').removeClass('visible').removeClass('active');
    //     // } else {
    //         $('.sort-fields').addClass('visible').removeClass('invisible').addClass('active');
    //     // }
    // })
